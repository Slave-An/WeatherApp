...
import 'package:weather_app/features/weather_screen/widgets/wind_widget/compas/compas.dart';
        ...
        child: Row(
          children: [
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text('${(allForecast.windKpH / 3.6).toInt()} mhp',
                          style: TextStyle(fontSize: 16, color: Colors.white))
                    ],
                  ),
                  Divider(),
                  Row(
                    ...
                    children: [
                      const Text('Gust:',
                          style: TextStyle(fontSize: 16, color: Colors.white)),
                      Text('${(allForecast.gustKph / 3.6).toInt()} mph',
                          style: TextStyle(fontSize: 16, color: Colors.white))
                    ],
                  ),
                  Divider(),
                  Row(
                    ...
                    children: [
                      const Text('Direction',
                          style: TextStyle(fontSize: 16, color: Colors.white)),
                      Text('${allForecast.windDegree}° ${allForecast.windDir}',
                          style: TextStyle(fontSize: 16, color: Colors.white))
                    ],
                  ),
                ],
            ...
            Padding(
              ...
              child: Compas(allForecast: allForecast),
            )
          ],
        ),
      ),
